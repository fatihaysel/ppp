...
var shareUrls = {
  ...
  qzone: '//wa.me/?text={title}%20{url}'
};
var shareIcons = {
  vkontakte: 'fab fa-vk',
  my_mail: 'fas fa-at',
  qq: 'fab fa-qq',
  qzone: 'fab fa-whatsapp'
};
...
function (_Modal) {
  ...
  _proto.content = function content() {
    ...
    var description = this.discussion.firstPost() ? encodeURIComponent(Object(flarum_utils_string__WEBPACK_IMPORTED_MODULE_3__["truncate"])(Object(flarum_utils_string__WEBPACK_IMPORTED_MODULE_3__["getPlainContent"])(this.discussion.moderationControls()), 150, 0)) : '';
    var data = {
      url: url,
      title: title,
...
/* harmony import */ var _components_ShareModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ShareModal */ "./src/forum/components/ShareModal.js");
...
app.initializers.add('fof/share-social', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'sidebarItems', function (items) {
    ...
    if (networks.length) {
      items.add('share-social', flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
        ...
        onclick: function onclick() {
          return app.modal.show(new _components_ShareModal__WEBPACK_IMPORTED_MODULE_4__["default"]({
            networks: networks,
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_3___default.a, 'moderationControls', function (items) {
    var _this2 = this;
